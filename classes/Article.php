...
class Article
{
    ...
    public static function getByID($conn, $id, $columns = '*')
    {
        ...
        /*przygotowanie zapytania metodą prepare*/
        $stmt = $conn->prepare($sql);

        /*powiazanie wartości z parametrem (nazwa, wartość, typ)*/
        $stmt->bindValue('id', $id, PDO::PARAM_INT);

        /*pobieranie klasy*/
        $stmt->setFetchMode(PDO::FETCH_CLASS, 'Article');

        /*metoda wykonujaca zapytanie na obiekcie? stmt*/
        if ($stmt->execute()) {
            /*metoda pobierającą*/
            return $stmt->fetch();
        }
    ...
    protected function validate()
    {
        ...
        /*sprawdzenie, czy nie pozostawiono pustych pól*/
        if ($this->title == '') {
    ...
    public static function getTotal($conn, $only_published = false)
    {
        ...
        /* to metoda query, nie prepared statement!*/
