...
/*dołączenie plików jako wymagane do wczytania*/
require 'includes/init.php';

/*pobieramy "obiekt" $conn*/
$conn = require 'includes/db.php';

/*sprawdzenie, czy zmienna id jest zadeklarowana i jest różna od null, sprawdzenie z kodu url*/
if (isset($_GET['id'])) {

    /*funkcja zwracająca artykuł*/
